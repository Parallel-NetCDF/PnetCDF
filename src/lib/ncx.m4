...
static int
APIPrefix`x_put_'NC_TYPE(short)_schar(void *xp, const schar *ip FILL_ARG)
{
	uchar *cp = (uchar *) xp;
	if (*ip & 0x80)
		*cp++ = 0xff;
...
static int
APIPrefix`x_put_'NC_TYPE(short)_uchar(void *xp, const uchar *ip FILL_ARG)
{
	uchar *cp = (uchar *) xp;
	*cp++ = 0;
	*cp = *ip;
...
static int
APIPrefix`x_put_'NC_TYPE(ushort)_uchar(void *xp, const uchar *ip FILL_ARG)
{
	uchar *cp = (uchar *) xp;
	*cp++ = 0;
	*cp = *ip;
...
static int
APIPrefix`x_put_'NC_TYPE(int)_schar(void *xp, const schar *ip FILL_ARG)
{
	uchar *cp = (uchar *) xp;
	if (*ip & 0x80)
	{
...
static int
APIPrefix`x_put_'NC_TYPE(int)_uchar(void *xp, const uchar *ip FILL_ARG)
{
	uchar *cp = (uchar *) xp;
	*cp++ = 0x00;
	*cp++ = 0x00;
...
static int
APIPrefix`x_put_'NC_TYPE(uint)_schar(void *xp, const schar *ip FILL_ARG)
{
    uchar *cp;
    if (*ip < 0) {
        FillValue(uint, xp)
...
static int
APIPrefix`x_put_'NC_TYPE(uint)_uchar(void *xp, const uchar *ip FILL_ARG)
{
	uchar *cp = (uchar *) xp;
	*cp++ = 0x00;
	*cp++ = 0x00;
...
#if X_SIZEOF_FLOAT != SIZEOF_FLOAT || defined(NO_IEEE_FLOAT)
static int
APIPrefix`x_get_'NC_TYPE(float)_float(const void *xp, float *ip FILL_ARG)
{
	/* TODO */
	get_ix_float(xp, ip);
	return NC_NOERR;
...
static int
APIPrefix`x_get_'NC_TYPE(double)_float(const void *xp, float *ip FILL_ARG)
{
    double xx;
    get_ix_double(xp, &xx);
    if (xx > FLT_MAX) {
...
#if X_SIZEOF_DOUBLE != SIZEOF_DOUBLE  || defined(NO_IEEE_FLOAT)
static int
APIPrefix`x_get_'NC_TYPE(double)_double(const void *xp, double *ip FILL_ARG)
{
	/* TODO */
	get_ix_double(xp, ip);
	return NC_NOERR;
...
`dnl
int
APIPrefix`x_getn_'NC_TYPE($1)_$2(const void **xpp, IntType nelems, $2 *tp FILL_ARG)
{
    int status = NC_NOERR;
    $1 *xp = ($1 *)(*xpp);
...
`dnl
int
APIPrefix`x_pad_getn_'NC_TYPE($1)_$2(const void **xpp, IntType nelems, $2 *tp FILL_ARG)
{
    int status = NC_NOERR;
    IntType rndup = nelems % X_ALIGN;
    $1 *xp = ($1 *) *xpp;
...
#pragma cdir shortloop
  ...
  return nrange == 0 ? NC_NOERR : NC_ERANGE;
	...
	{
		const int lstatus = APIPrefix`x_get_'NC_TYPE($1)_$2(xp, tp XFILL);
...
`dnl
int
APIPrefix`x_putn_'NC_TYPE($1)_$2(void **xpp, IntType nelems, const $2 *tp FILL_ARG)
{
    int status = NC_NOERR;
    $1 *xp = ($1 *) *xpp;
...
`dnl
int
APIPrefix`x_pad_putn_'NC_TYPE($1)_$2(void **xpp, IntType nelems, const $2 *tp FILL_ARG)
{
    int status = NC_NOERR;
    IntType rndup = nelems % X_ALIGN;
    $1 *xp = ($1 *) *xpp;
...
')dnl
  ...
  return nrange == 0 ? NC_NOERR : NC_ERANGE;
	...
	for( ; nelems != 0; nelems--, xp += Xsizeof($1), tp++)
	{
		int lstatus = APIPrefix`x_put_'NC_TYPE($1)_$2(xp, tp XFILL);
		if (status == NC_NOERR) /* report the first encountered error */
			status = lstatus;
	}
...
int
APIPrefix`x_getn_'NC_TYPE(schar)_schar(const void **xpp, IntType nelems, schar *tp FILL_ARG)
{
	NCX_GETN_Byte_Body
}
...
int
APIPrefix`x_pad_getn_'NC_TYPE(schar)_schar(const void **xpp, IntType nelems, schar *tp FILL_ARG)
{
...
int
APIPrefix`x_putn_'NC_TYPE(schar)_schar(void **xpp, IntType nelems, const schar *tp FILL_ARG)
{
	NCX_PUTN_Byte_Body
}
...
int
APIPrefix`x_pad_putn_'NC_TYPE(schar)_schar(void **xpp, IntType nelems, const schar *tp FILL_ARG)
{
...
int
APIPrefix`x_getn_'NC_TYPE(uchar)_schar(const void **xpp, IntType nelems, schar *tp FILL_ARG)
{
    int status = NC_NOERR;
    uchar *xp = (uchar *)(*xpp);
...
int
APIPrefix`x_getn_'NC_TYPE(uchar)_uchar(const void **xpp, IntType nelems, uchar *tp FILL_ARG)
{
	NCX_GETN_Byte_Body
}
...
int
APIPrefix`x_pad_getn_'NC_TYPE(uchar)_schar(const void **xpp, IntType nelems, schar *tp FILL_ARG)
{
    int status = NC_NOERR;
    IntType rndup = nelems % X_ALIGN;
    uchar *xp = (uchar *) *xpp;
...
int
APIPrefix`x_pad_getn_'NC_TYPE(uchar)_uchar(const void **xpp, IntType nelems, uchar *tp FILL_ARG)
{
	NCX_PAD_GETN_Byte_Body
}
...
int
APIPrefix`x_putn_'NC_TYPE(uchar)_schar(void **xpp, IntType nelems, const schar *tp FILL_ARG)
{
    int status = NC_NOERR;
    uchar *xp = (uchar *) *xpp;
...
int
APIPrefix`x_putn_'NC_TYPE(uchar)_uchar(void **xpp, IntType nelems, const uchar *tp FILL_ARG)
{
	NCX_PUTN_Byte_Body
}
...
int
APIPrefix`x_pad_putn_'NC_TYPE(uchar)_schar(void **xpp, IntType nelems, const schar *tp FILL_ARG)
{
    int status = NC_NOERR;
    IntType rndup = nelems % X_ALIGN;
    uchar *xp = (uchar *) *xpp;
...
int
APIPrefix`x_pad_putn_'NC_TYPE(uchar)_uchar(void **xpp, IntType nelems, const uchar *tp FILL_ARG)
{
	NCX_PAD_PUTN_Byte_Body
}
...
/* optimized version */
int
APIPrefix`x_getn_'NC_TYPE(short)_short(const void **xpp, IntType nelems, short *tp FILL_ARG)
{
#ifdef WORDS_BIGENDIAN
...
/* optimized version */
int
APIPrefix`x_putn_'NC_TYPE(short)_short(void **xpp, IntType nelems, const short *tp FILL_ARG)
{
#ifdef WORDS_BIGENDIAN
...
/* optimized version */
int
APIPrefix`x_getn_'NC_TYPE(ushort)_ushort(const void **xpp, IntType nelems, unsigned short *tp FILL_ARG)
{
#ifdef WORDS_BIGENDIAN
...
/* optimized version */
int
APIPrefix`x_putn_'NC_TYPE(ushort)_ushort(void **xpp, IntType nelems, const unsigned short *tp FILL_ARG)
{
#ifdef WORDS_BIGENDIAN
...
/* optimized version */
int
APIPrefix`x_getn_'NC_TYPE(int)_int(const void **xpp, IntType nelems, int *tp FILL_ARG)
{
#ifdef WORDS_BIGENDIAN
...
/* optimized version */
int
APIPrefix`x_putn_'NC_TYPE(int)_int(void **xpp, IntType nelems, const int *tp FILL_ARG)
{
#ifdef WORDS_BIGENDIAN
...
/* optimized version */
int
APIPrefix`x_getn_'NC_TYPE(uint)_uint(const void **xpp, IntType nelems, unsigned int *tp FILL_ARG)
{
#ifdef WORDS_BIGENDIAN
...
/* optimized version */
int
APIPrefix`x_putn_'NC_TYPE(uint)_uint(void **xpp, IntType nelems, const unsigned int *tp FILL_ARG)
{
#ifdef WORDS_BIGENDIAN
...
/* optimized version */
int
APIPrefix`x_getn_'NC_TYPE(float)_float(const void **xpp, IntType nelems, float *tp FILL_ARG)
{
#ifdef WORDS_BIGENDIAN
...
#elif defined(vax) && vax != 0
int
APIPrefix`x_getn_'NC_TYPE(float)_float(const void **xpp, IntType nfloats, float *ip FILL_ARG)
{
...
APIPrefix`x_getn_'NC_TYPE(float)_float(const void **xpp, IntType nelems, float *tp FILL_ARG)
{
	...
	{
		const int lstatus = APIPrefix`x_get_'NC_TYPE(float)_float(xp, tp XFILL);
		if (status == NC_NOERR) /* report the first encountered error */
			status = lstatus;
	}
...
int
APIPrefix`x_putn_'NC_TYPE(float)_float(void **xpp, IntType nelems, const float *tp FILL_ARG)
#if X_SIZEOF_FLOAT == SIZEOF_FLOAT && !defined(NO_IEEE_FLOAT)
/* optimized version */
{
#ifdef WORDS_BIGENDIAN
...
#else
{
	...
	for( ; nelems != 0; nelems--, xp += X_SIZEOF_FLOAT, tp++) {
		int lstatus = APIPrefix`x_put_'NC_TYPE(float)_float(xp, tp XFILL);
		if (status == NC_NOERR) /* report the first encountered error */
			status = lstatus;
	}
...
/* optimized version */
int
APIPrefix`x_getn_'NC_TYPE(double)_double(const void **xpp, IntType nelems, double *tp FILL_ARG)
{
#ifdef WORDS_BIGENDIAN
...
#elif defined(vax) && vax != 0
int
APIPrefix`x_getn_'NC_TYPE(double)_double(const void **xpp, IntType ndoubles, double *ip FILL_ARG)
{
...
APIPrefix`x_getn_'NC_TYPE(double)_double(const void **xpp, IntType nelems, double *tp FILL_ARG)
{
	...
	{
		const int lstatus = APIPrefix`x_get_'NC_TYPE(double)_double(xp, tp XFILL);
		if (status == NC_NOERR) /* report the first encountered error */
			status = lstatus;
	}
...
/* optimized version */
int
APIPrefix`x_putn_'NC_TYPE(double)_double(void **xpp, IntType nelems, const double *tp FILL_ARG)
{
#ifdef WORDS_BIGENDIAN
...
#elif defined(vax) && vax != 0
int
APIPrefix`x_putn_'NC_TYPE(double)_double(void **xpp, IntType ndoubles, const double *ip FILL_ARG)
{
...
APIPrefix`x_putn_'NC_TYPE(double)_double(void **xpp, IntType nelems, const double *tp FILL_ARG)
{
	...
	for( ; nelems != 0; nelems--, xp += X_SIZEOF_DOUBLE, tp++)
	{
		int lstatus = APIPrefix`x_put_'NC_TYPE(double)_double(xp, tp XFILL);
		if (status == NC_NOERR) /* report the first encountered error */
			status = lstatus;
	}
...
/* optimized version */
int
APIPrefix`x_getn_'NC_TYPE(int64)_longlong(const void **xpp, IntType nelems, long long *tp FILL_ARG)
{
#ifdef WORDS_BIGENDIAN
...
/* optimized version */
int
APIPrefix`x_putn_'NC_TYPE(int64)_longlong(void **xpp, IntType nelems, const long long *tp FILL_ARG)
{
#ifdef WORDS_BIGENDIAN
...
/* optimized version */
int
APIPrefix`x_getn_'NC_TYPE(uint64)_ulonglong(const void **xpp, IntType nelems, unsigned long long *tp FILL_ARG)
{
#ifdef WORDS_BIGENDIAN
...
/* optimized version */
int
APIPrefix`x_putn_'NC_TYPE(uint64)_ulonglong(void **xpp, IntType nelems, const unsigned long long *tp FILL_ARG)
{
#ifdef WORDS_BIGENDIAN
