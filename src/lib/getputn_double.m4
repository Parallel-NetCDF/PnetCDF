...
dnl
dnl GET_DOUBLE(xp, ip)
dnl
define(`GET_DOUBLE',dnl
`dnl
/*----< ncmpix_get_double_$1() >----------------------------------------------*/
static int
ncmpix_get_double_$1(const void *xp, $1 *ip)
{
    double xx=0.0;
    get_ix_double(xp, &xx);
    *ip = xx;
...
dnl
define(`PUT_DOUBLE',dnl
`dnl
/*----< ncmpix_put_double_$1() >----------------------------------------------*/
static int
ncmpix_put_double_$1(void *xp, const $1 *ip)
{
    double xx = (double) *ip;
    put_ix_double(xp, &xx);
    return NC_NOERR;
...
dnl
dnl GETN_DOUBLE(xpp, nelems, tp)
dnl
define(`GETN_DOUBLE',dnl
`dnl
/*----< ncmpix_getn_double_$1() >---------------------------------------------*/
int
ncmpix_getn_double_$1(const void **xpp, MPI_Offset nelems, $1 *tp)
{
    const char *xp = (const char *) *xpp;
    int status = NC_NOERR;

    for ( ; nelems != 0; nelems--, xp += X_SIZEOF_DOUBLE, tp++) {
        const int lstatus = ncmpix_get_double_$1(xp, tp);
...
dnl
dnl PUTN_DOUBLE(xpp, nelems, tp)
dnl
define(`PUTN_DOUBLE',dnl
`dnl
/*----< ncmpix_putn_double_$1() >---------------------------------------------*/
int
ncmpix_putn_double_$1(void **xpp, MPI_Offset nelems, const $1 *tp)
{
    char *xp = (char *) *xpp;
    int status = NC_NOERR;

    for ( ; nelems != 0; nelems--, xp += X_SIZEOF_DOUBLE, tp++) {
        int lstatus = ncmpix_put_double_$1(xp, tp);
        if (lstatus != NC_NOERR) status = lstatus;
    }
