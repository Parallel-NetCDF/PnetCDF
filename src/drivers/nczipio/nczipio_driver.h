...
extern int nczipio_create (
	MPI_Comm comm, const char *path, int cmode, int ncid, MPI_Info info, void **ncdp);

extern int nczipio_open (
	MPI_Comm comm, const char *path, int omode, int ncid, MPI_Info info, void **ncdp);

extern int nczipio_close (void *ncdp);

extern int nczipio_enddef (void *ncdp);

extern int nczipio__enddef (
	void *ncdp, MPI_Offset h_minfree, MPI_Offset v_align, MPI_Offset v_minfree, MPI_Offset r_align);

extern int nczipio_redef (void *ncdp);

extern int nczipio_sync (void *ncdp);

extern int nczipio_flush (void *ncdp);

extern int nczipio_abort (void *ncdp);

extern int nczipio_set_fill (void *ncdp, int fill_mode, int *old_fill_mode);

extern int nczipio_fill_var_rec (void *ncdp, int varid, MPI_Offset recno);

extern int nczipio_inq (void *ncdp, int *ndimsp, int *nvarsp, int *nattsp, int *xtendimp);

extern int nczipio_inq_misc (void *ncdp,
							 int *pathlen,
							 char *path,
							 int *num_fix_varsp,
							 int *num_rec_varsp,
...
extern int nczipio_sync_numrecs (void *ncdp);

extern int nczipio_begin_indep_data (void *ncdp);

extern int nczipio_end_indep_data (void *ncdp);

extern int nczipio_def_dim (void *ncdp, const char *name, MPI_Offset size, int *dimidp);

extern int nczipio_inq_dimid (void *ncdp, const char *name, int *dimidp);

extern int nczipio_inq_dim (void *ncdp, int dimid, char *name, MPI_Offset *lengthp);

extern int nczipio_rename_dim (void *ncdp, int dimid, const char *newname);

extern int nczipio_inq_att (
	void *ncdp, int varid, const char *name, nc_type *xtypep, MPI_Offset *lenp);

extern int nczipio_inq_attid (void *ncdp, int varid, const char *name, int *idp);

extern int nczipio_inq_attname (void *ncdp, int varid, int attnum, char *name);

extern int nczipio_copy_att (
	void *ncdp_in, int varid_in, const char *name, void *ncdp_out, int varid_out);

extern int nczipio_rename_att (void *ncdp, int varid, const char *name, const char *newname);

extern int nczipio_del_att (void *ncdp, int varid, const char *name);

extern int nczipio_get_att (
	void *ncdp, int varid, const char *name, void *value, MPI_Datatype itype);

extern int nczipio_put_att (void *ncdp,
							int varid,
							const char *name,
							nc_type xtype,
							MPI_Offset nelems,
...
extern int nczipio_def_var (
	void *ncdp, const char *name, nc_type type, int ndims, const int *dimids, int *varidp);

extern int nczipio_def_var_fill (void *ncdp, int varid, int nofill, const void *fill_value);

extern int nczipio_inq_var (void *ncdp,
							int varid,
							char *name,
							nc_type *xtypep,
							int *ndimsp,
...
extern int nczipio_inq_varid (void *ncdp, const char *name, int *varid);

extern int nczipio_rename_var (void *ncdp, int varid, const char *newname);

extern int nczipio_get_var (void *ncdp,
							int varid,
...
extern int nczipio_put_var (void *ncdp,
							int varid,
							const MPI_Offset *start,
							const MPI_Offset *count,
							const MPI_Offset *stride,
...
extern int nczipio_get_varn (void *ncdp,
							 int varid,
							 int num,
...
extern int nczipio_put_varn (void *ncdp,
							 int varid,
							 int num,
							 MPI_Offset *const *starts,
							 MPI_Offset *const *counts,
...
extern int nczipio_get_vard (void *ncdp,
							 int varid,
...
extern int nczipio_put_vard (void *ncdp,
							 int varid,
							 MPI_Datatype filetype,
							 const void *buf,
							 MPI_Offset bufcount,
...
extern int nczipio_iget_var (void *ncdp,
							 int varid,
							 const MPI_Offset *start,
							 const MPI_Offset *count,
							 const MPI_Offset *stride,
...
extern int nczipio_iput_var (void *ncdp,
							 int varid,
							 const MPI_Offset *start,
							 const MPI_Offset *count,
							 const MPI_Offset *stride,
...
extern int nczipio_bput_var (void *ncdp,
							 int varid,
							 const MPI_Offset *start,
							 const MPI_Offset *count,
							 const MPI_Offset *stride,
...
extern int nczipio_iget_varn (void *ncdp,
							  int varid,
							  int num,
							  MPI_Offset *const *starts,
							  MPI_Offset *const *counts,
...
extern int nczipio_iput_varn (void *ncdp,
							  int varid,
							  int num,
							  MPI_Offset *const *starts,
							  MPI_Offset *const *counts,
...
extern int nczipio_bput_varn (void *ncdp,
							  int varid,
							  int num,
							  MPI_Offset *const *starts,
							  MPI_Offset *const *counts,
...
extern int nczipio_buffer_attach (void *ncdp, MPI_Offset bufsize);

extern int nczipio_buffer_detach (void *ncdp);

extern int nczipio_wait (void *ncdp, int num_reqs, int *req_ids, int *statuses, int reqMode);

extern int nczipio_cancel (void *ncdp, int num_reqs, int *req_ids, int *statuses);
