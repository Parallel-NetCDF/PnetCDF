...
#define nfmpi_iget_vara_double_all_ NFMPI_IGET_VARA_DOUBLE_ALL
#elif defined(F77_NAME_LOWER_2USCORE)
#define nfmpi_iget_vara_double_all_ nfmpi_iget_vara_double_all__
...
FORTRAN_API int FORT_CALL nfmpi_iget_vara_double_all_ ( int *v1, int *v2, MPI_Offset v3[], MPI_Offset v4[], void*v5, MPI_Offset *v6, MPI_Fint *v7 ){
    int ierr;
    int l2 = *v2 - 1;
    MPI_Offset *l3 = 0;
    MPI_Offset *l4 = 0;
    ...
    ierr = ncmpi_iget_vara_double_all( *v1, l2, l3, l4, v5, *v6, &l7_req );
    if (req_head==NULL) {
