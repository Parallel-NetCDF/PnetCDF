...
FORTRAN_API int FORT_CALL nfmpi_get_varn_all_ ( int *v1, int *v2, int *v3, void*v4, MPI_Offset *v5, MPI_Fint *v6 ){
    int ierr;
    int l2 = *v2 - 1;
    ierr = ncmpi_get_varn_all( *v1, l2, *v3, v4, *v5, MPI_Type_f2c(*v6) );
    return ierr;
}
