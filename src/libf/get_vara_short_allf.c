...
FORTRAN_API void FORT_CALL nfmpi_get_vara_short_all_ ( int *v1, int *v2, size_t v3[], size_t v4[], short*v5, MPI_Fint *ierr ){
    size_t *l3;
    size_t *l4;
    ...
    l4 = v4;
#endif
    *ierr = ncmpi_get_vara_short_all( *v1, *v2, l3, l4, v5 );
