...
#define nfmpi_put_varn1_real_all_ NFMPI_PUT_VARN1_REAL_ALL
#elif defined(F77_NAME_LOWER_2USCORE)
#define nfmpi_put_varn1_real_all_ nfmpi_put_varn1_real_all__
...
FORTRAN_API int FORT_CALL nfmpi_put_varn1_real_all_ ( int *v1, int *v2, int *v3, MPI_Offset*v4, float*v5 ){
    int ierr;
    int l2 = *v2 - 1;
    MPI_Offset **l4 = 0;
    ...
    ierr = ncmpi_put_varn1_float_all( *v1, l2, *v3, l4, v5 );
