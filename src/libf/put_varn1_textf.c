...
#define nfmpi_put_varn1_text_ NFMPI_PUT_VARN1_TEXT
#elif defined(F77_NAME_LOWER_2USCORE)
#define nfmpi_put_varn1_text_ nfmpi_put_varn1_text__
...
FORTRAN_API int FORT_CALL nfmpi_put_varn1_text_ ( int *v1, int *v2, int *v3, MPI_Offset *v4, char *v5 FORT_MIXED_LEN(d5) FORT_END_LEN(d5) ){
    int ierr;
    int l2 = *v2 - 1;
    MPI_Offset **l4 = 0;
    ...
    ierr = ncmpi_put_varn1_text( *v1, l2, *v3, l4, v5 );
