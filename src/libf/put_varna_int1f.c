...
#define nfmpi_put_varna_int1_ NFMPI_PUT_VARNA_INT1
#elif defined(F77_NAME_LOWER_2USCORE)
#define nfmpi_put_varna_int1_ nfmpi_put_varna_int1__
...
FORTRAN_API int FORT_CALL nfmpi_put_varna_int1_ ( int *v1, int *v2, int *v3, MPI_Offset*v4, MPI_Offset*v5, const signed char * v6 ){
    int ierr;
    int l2 = *v2 - 1;
    MPI_Offset **l4 = 0;
    MPI_Offset **l5 = 0;
    ...
    ierr = ncmpi_put_varna_schar( *v1, l2, *v3, l4, l5, v6 );
