...
FORTRAN_API int FORT_CALL nfmpi_get_varm_all_ ( int *v1, int *v2, MPI_Offset v3[], MPI_Offset v4[], MPI_Offset v5[], MPI_Offset v6[], void*v7, int *v8, MPI_Fint *v9 ){
    int ierr;
    int l2 = *v2 - 1;
    MPI_Offset *l3 = 0;
    MPI_Offset *l4 = 0;
    ...
    ierr = ncmpi_get_varm_all( *v1, l2, l3, l4, l5, l6, v7, *v8, (MPI_Datatype)(*v9) );
