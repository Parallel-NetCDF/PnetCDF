...
FORTRAN_API int FORT_CALL nfmpi_put_varn_text_all_ ( int *v1, int *v2, int *v3, char *v4 FORT_MIXED_LEN(d4) FORT_END_LEN(d4) ){
    int ierr;
    int l2 = *v2 - 1;
    ierr = ncmpi_put_varn_text_all( *v1, l2, *v3, v4 );
    return ierr;
}
