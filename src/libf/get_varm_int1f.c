...
FORTRAN_API int FORT_CALL nfmpi_get_varm_int1_ ( int *v1, int *v2, MPI_Offset v3[], MPI_Offset v4[], MPI_Offset v5[], MPI_Offset v6[], char *v7 FORT_MIXED_LEN(d7) FORT_END_LEN(d7) ){
    int ierr;
    int l2 = *v2 - 1;
    MPI_Offset *l3 = 0;
    MPI_Offset *l4 = 0;
