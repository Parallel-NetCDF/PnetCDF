...
#define nfmpi_get_varnm_real_ NFMPI_GET_VARNM_REAL
#elif defined(F77_NAME_LOWER_2USCORE)
#define nfmpi_get_varnm_real_ nfmpi_get_varnm_real__
...
FORTRAN_API int FORT_CALL nfmpi_get_varnm_real_ ( int *v1, int *v2, int *v3, MPI_Offset*v4, MPI_Offset*v5, MPI_Offset*v6, MPI_Offset*v7, float*v8 ){
    int ierr;
    int l2 = *v2 - 1;
    MPI_Offset **l4 = 0;
    MPI_Offset **l5 = 0;
    ...
    ierr = ncmpi_get_varnm_float( *v1, l2, *v3, l4, l5, l6, l7, v8 );
