...
#define nfmpi_put_varna_double_all_ NFMPI_PUT_VARNA_DOUBLE_ALL
#elif defined(F77_NAME_LOWER_2USCORE)
#define nfmpi_put_varna_double_all_ nfmpi_put_varna_double_all__
...
FORTRAN_API int FORT_CALL nfmpi_put_varna_double_all_ ( int *v1, int *v2, int *v3, MPI_Offset *v4, MPI_Offset *v5, double *v6 ){
    int ierr;
    int l2 = *v2 - 1;
    MPI_Offset **l4 = 0;
    MPI_Offset **l5 = 0;
    ...
    ierr = ncmpi_put_varna_double_all( *v1, l2, *v3, l4, l5, v6 );
