...
#define nfmpi_put_varns_int8_ NFMPI_PUT_VARNS_INT8
#elif defined(F77_NAME_LOWER_2USCORE)
#define nfmpi_put_varns_int8_ nfmpi_put_varns_int8__
...
FORTRAN_API int FORT_CALL nfmpi_put_varns_int8_ ( int *v1, int *v2, int *v3, MPI_Offset*v4, MPI_Offset*v5, MPI_Offset*v6, const long long * v7 ){
    int ierr;
    int l2 = *v2 - 1;
    MPI_Offset **l4 = 0;
    MPI_Offset **l5 = 0;
    ...
    ierr = ncmpi_put_varns_longlong( *v1, l2, *v3, l4, l5, l6, v7 );
