...
#define nfmpi_get_varna_ NFMPI_GET_VARNA
#elif defined(F77_NAME_LOWER_2USCORE)
#define nfmpi_get_varna_ nfmpi_get_varna__
...
FORTRAN_API int FORT_CALL nfmpi_get_varna_ ( int *v1, int *v2, int *v3, MPI_Offset*v4, MPI_Offset*v5, void*v6, MPI_Offset *v7, MPI_Fint *v8 ){
    int ierr;
    int l2 = *v2 - 1;
    MPI_Offset **l4 = 0;
    MPI_Offset **l5 = 0;
    ...
    ierr = ncmpi_get_varna( *v1, l2, *v3, l4, l5, v6, *v7, MPI_Type_f2c(*v8) );
