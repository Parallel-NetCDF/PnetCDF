...
FORTRAN_API int FORT_CALL nfmpi_get_vars_ ( int *v1, int *v2, MPI_Offset v3[], MPI_Offset v4[], MPI_Offset v5[], void*v6, int *v7, MPI_Fint *v8 ){
    int ierr;
    int l2 = *v2 - 1;
    MPI_Offset *l3 = 0;
    MPI_Offset *l4 = 0;
    ...
    ierr = ncmpi_get_vars( *v1, l2, l3, l4, l5, v6, *v7, (MPI_Datatype)(*v8) );
