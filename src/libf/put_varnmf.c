...
#define nfmpi_put_varnm_ NFMPI_PUT_VARNM
#elif defined(F77_NAME_LOWER_2USCORE)
#define nfmpi_put_varnm_ nfmpi_put_varnm__
...
FORTRAN_API int FORT_CALL nfmpi_put_varnm_ ( int *v1, int *v2, int *v3, MPI_Offset*v4, MPI_Offset*v5, MPI_Offset*v6, MPI_Offset*v7, void*v8, MPI_Offset *v9, MPI_Fint *v10 ){
    int ierr;
    int l2 = *v2 - 1;
    MPI_Offset **l4 = 0;
    MPI_Offset **l5 = 0;
    ...
    ierr = ncmpi_put_varnm( *v1, l2, *v3, l4, l5, l6, l7, v8, *v9, MPI_Type_f2c(*v10) );
