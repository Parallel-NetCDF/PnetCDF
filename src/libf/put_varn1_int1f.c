...
#define nfmpi_put_varn1_int1_ NFMPI_PUT_VARN1_INT1
#elif defined(F77_NAME_LOWER_2USCORE)
#define nfmpi_put_varn1_int1_ nfmpi_put_varn1_int1__
...
FORTRAN_API int FORT_CALL nfmpi_put_varn1_int1_ ( int *v1, int *v2, int *v3, MPI_Offset*v4, const signed char * v5 ){
    int ierr;
    int l2 = *v2 - 1;
    MPI_Offset **l4 = 0;
    ...
    ierr = ncmpi_put_varn1_schar( *v1, l2, *v3, l4, v5 );
