...
#define nfmpi_get_varn1_ NFMPI_GET_VARN1
#elif defined(F77_NAME_LOWER_2USCORE)
#define nfmpi_get_varn1_ nfmpi_get_varn1__
...
FORTRAN_API int FORT_CALL nfmpi_get_varn1_ ( int *v1, int *v2, int *v3, MPI_Offset *v4, void *v5, MPI_Offset *v6, MPI_Fint *v7 ){
    int ierr;
    int l2 = *v2 - 1;
    MPI_Offset **l4 = 0;
    ...
    ierr = ncmpi_get_varn1( *v1, l2, *v3, l4, v5, *v6, MPI_Type_f2c(*v7) );
