...
#define nfmpi_get_varna_text_ NFMPI_GET_VARNA_TEXT
#elif defined(F77_NAME_LOWER_2USCORE)
#define nfmpi_get_varna_text_ nfmpi_get_varna_text__
...
FORTRAN_API int FORT_CALL nfmpi_get_varna_text_ ( int *v1, int *v2, int *v3, MPI_Offset *v4, MPI_Offset *v5, char *v6 FORT_MIXED_LEN(d6) FORT_END_LEN(d6) ){
    int ierr;
    int l2 = *v2 - 1;
    MPI_Offset **l4 = 0;
    MPI_Offset **l5 = 0;
    ...
    ierr = ncmpi_get_varna_text( *v1, l2, *v3, l4, l5, v6 );
