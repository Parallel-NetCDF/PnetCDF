...
extern int
ncmpi_iput_var1_string(int ncid, int varid, const MPI_Offset *indexp, const char **op, int *req);

extern int
ncmpi_bput_var1_string(int ncid, int varid, const MPI_Offset *indexp, const char **op, int *req);

extern int
ncmpi_iget_var1_string(int ncid, int varid, const MPI_Offset *indexp, char **ip, int *req);

extern int
ncmpi_iput_var_string(int ncid, int varid, const char **op, int *req);

extern int
ncmpi_bput_var_string(int ncid, int varid, const char **op, int *req);

extern int
ncmpi_iget_var_string(int ncid, int varid, char **ip, int *req);

extern int
ncmpi_iput_vara_string(int ncid, int varid, const MPI_Offset *startp, const MPI_Offset *countp, const char **op, int *req);

extern int
ncmpi_bput_vara_string(int ncid, int varid, const MPI_Offset *startp, const MPI_Offset *countp, const char **op, int *req);

extern int
ncmpi_iget_vara_string(int ncid, int varid, const MPI_Offset *startp, const MPI_Offset *countp, char **ip, int *req);

extern int
ncmpi_iput_vars_string(int ncid, int varid, const MPI_Offset *startp, const MPI_Offset *countp, const MPI_Offset *stridep, const char **op, int *req);

extern int
ncmpi_bput_vars_string(int ncid, int varid, const MPI_Offset *startp, const MPI_Offset *countp, const MPI_Offset *stridep, const char **op, int *req);

extern int
ncmpi_iget_vars_string(int ncid, int varid, const MPI_Offset *startp, const MPI_Offset *countp, const MPI_Offset *stridep, char **ip, int *req);

extern int
ncmpi_iput_varm_string(int ncid, int varid, const MPI_Offset *startp, const MPI_Offset *countp, const MPI_Offset *stridep, const MPI_Offset * imapp, const char **op, int *req);

extern int
ncmpi_bput_varm_string(int ncid, int varid, const MPI_Offset *startp, const MPI_Offset *countp, const MPI_Offset *stridep, const MPI_Offset * imapp, const char **op, int *req);

extern int
ncmpi_iget_varm_string(int ncid, int varid, const MPI_Offset *startp, const MPI_Offset *countp, const MPI_Offset *stridep, const MPI_Offset * imapp, char **ip, int *req);
