...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 *
 * This example shows how to use PnetCDF flexible varm APIs, i.e.
 * ncmpi_put_varm_all(), ncmpi_get_varm_all(), and their nonblocking versions,
 * to write a 2D array double variable of size NY x NX*nproc in parallel.
 *
