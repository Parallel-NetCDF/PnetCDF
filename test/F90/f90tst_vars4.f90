...
!  endif
  ...
  call handle_err(nf90mpi_create(MPI_COMM_SELF, out_path, mode_flag, MPI_INFO_NULL, ncid))
  ...
  ! Reopen the file.
  call handle_err(nf90mpi_open(MPI_COMM_SELF, out_path, nf90_nowrite, MPI_INFO_NULL, ncid))
