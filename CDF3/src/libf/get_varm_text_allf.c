...
FORTRAN_API int FORT_CALL nfmpi_get_varm_text_all_ ( int *v1, int64_t *v2, int64_t v3[], int64_t v4[], int64_t v5[], int64_t v6[], char *v7 FORT_MIXED_LEN(d7) FORT_END_LEN(d7) ){
    int ierr;
    int l2 = *v2 - 1;
    MPI_Offset *l3 = 0;
    MPI_Offset *l4 = 0;
